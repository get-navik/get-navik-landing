    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-blue-900 dark:to-gray-900">
      ...
      <header className="container mx-auto px-4 lg:px-6 h-20 flex items-center justify-between">
        ...
        <nav className="flex gap-4 sm:gap-6">
          <Link
            className="text-sm font-medium text-gray-600 hover:text-[#0a1128] transition-colors dark:text-gray-300 dark:hover:text-blue-400"
            href="#about"
          >
            About
          </Link>
      ...
      <main className="flex-1">
        ...
        >
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-8 text-[#0a1128] dark:text-blue-400">
              Why Navik?
            </h2>
      ...
      <footer className="py-6 px-4 border-t border-gray-200 dark:border-gray-800">
        <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center">
          ...
          <nav className="flex gap-4 mt-4 sm:mt-0">
            <Link
              className="text-sm text-gray-500 hover:text-[#0a1128] dark:text-gray-400 dark:hover:text-blue-400"
              href="#"
            >
              Privacy Policy
            </Link>
